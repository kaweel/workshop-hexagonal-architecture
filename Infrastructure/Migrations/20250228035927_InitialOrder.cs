    ...
    public partial class InitialOrder : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopOrders", x => new { x.OrderId, x.ShopId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_ShopOrders_OrderId_ShopId",
                        columns: x => new { x.OrderId, x.ShopId },
                        principalTable: "ShopOrders",
                        principalColumns: new[] { "OrderId", "ShopId" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OrderId_ShopId",
                table: "OrderItems",
